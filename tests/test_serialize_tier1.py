...
def test_serialize_user_fills_blanks():
    u = SimpleNamespace(id=7, first_name="Al", last_name=None,
...
def test_serialize_search_message_includes_chat_id():
    msg = SimpleNamespace(id=3, chat_id=99, date=datetime(2026, 1, 1, tzinfo=timezone.utc),
                          sender_id=5, text="hi", media=None, photo=None, voice=None,
