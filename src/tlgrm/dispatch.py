...
async def _login(name: str | None = None) -> None:
...
def run_account_command(args: argparse.Namespace) -> None:
        ...
        emit(
            {
                ...
                "default": default,
                "accounts": [
                    {"name": n, "default": n == default} for n in cfg["accounts"]
                ],
            }
        )
    elif cmd == "use":
...
def run_command_routed(args: argparse.Namespace) -> None:
